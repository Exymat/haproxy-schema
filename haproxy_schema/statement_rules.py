...
BASE_STATEMENT_RULES: list[StatementRule] = [
    ...
    StatementRule(keyword="acl", kind="acl-criterion", group="acl_criteria", value_token_index=2),
    StatementRule(keyword="filter", kind="filter", group="filters", value_token_index=1),
    StatementRule(keyword="use_backend", kind="directive", value_token_index=1),
    StatementRule(keyword="use-server", kind="directive", value_token_index=1),
    StatementRule(keyword="default_backend", kind="directive", value_token_index=1),
